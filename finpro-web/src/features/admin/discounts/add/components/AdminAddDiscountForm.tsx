...
import { IAddDiscountForm, IPriceCutSelectedProduct, TDiscountType } from "@/types/discounts/discount.type";
...
import { useAdminAddDiscounts } from "../hooks/useAdminAddDiscounts";

export default function AdminAddDiscountForm({
  values,
  setFieldValue,
}: {
  values: IAddDiscountForm;
  setFieldValue: (field: string, value: string[] | IPriceCutSelectedProduct[] | string | number | boolean) => void;
}) {
  const {
    stores,
    products,
